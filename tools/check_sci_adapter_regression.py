...
from audit_sci_adapter import C17,C19,C24
from check_sci_adapter import nested_errors
...
def run():
    ...
    with tempfile.TemporaryDirectory(prefix='mincompat_historical_',dir=ROOT/'outputs') as directory:
        ...
        for label,commit,file in (('c2',BASE_COMMIT,BASE_YAML),('c17',C17,'rtdetr-resnet18-lite-cscef-v51.yaml'),
            ...
            model=RTDETRDetectionModel(str(MODEL_DIR/(LEGACY['c25'] if label=='c25' else file)),nc=1,verbose=False).eval()
