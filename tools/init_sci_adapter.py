...
import torch
from sci_adapter import (ROOT, MODEL_DIR, BASE_COMMIT, SOURCE_SHA256, VARIANTS, build, common_key,
...
def controlled_models(source, variant):
    ...
    report=dict(status="passed", variant=variant, c2_commit=BASE_COMMIT, source_sha256=SOURCE_SHA256,
        ...
        mapping="Validated semantic main-graph correspondence; SCI and C17 insertions shift C2 layers 18..26 to 20..28; CSCEF semantic is the existing upsampled Y4",
