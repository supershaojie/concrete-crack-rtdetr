...
from init_mincompat_v2 import controlled_models, initialize, rebuild_audit
from check_mincompat_v2_gradients import run_checks, activate
...
def smoke(target,variant,device='cpu',amp=False):
    ...
    rebuilt=__import__('init_mincompat_v2').rebuild_nc1(loaded)
