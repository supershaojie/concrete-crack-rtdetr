...
import shutil
import torch
from triad_compat import ROOT,require,sha256,write_json,YAML
from triad_compat_results import evaluate
...
def run(data_root,weights,output):
    ...
    for split in ('val','test'):
        report=evaluate('triad_v1',weights,cfg,split,output/split,
