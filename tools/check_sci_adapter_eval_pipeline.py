...
import shutil
import torch
from sci_adapter import ROOT,require,sha256,write_json,YAML
from sci_adapter_results import evaluate
...
def run(data_root,weights,output):
    ...
    for split in ('val','test'):
        report=evaluate('scca_sci_cscef_v51_cbr',weights,cfg,split,output/split,
