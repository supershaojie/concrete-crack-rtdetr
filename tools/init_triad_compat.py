...
import torch
from triad_compat import (ROOT, MODEL_DIR, BASE_COMMIT, SOURCE_SHA256, VARIANTS, build, common_key,
...
def controlled_models(source, variant):
    ...
    report=dict(status="passed", variant=variant, c2_commit=BASE_COMMIT, source_sha256=SOURCE_SHA256,
        ...
        mapping="Validated semantic main-graph correspondence; decoder index shifts only when a late sidecar is present",
