...
from lif_down_results import evaluate, postprocess
...
def main():
    ...
    write_json(ROOT/'docs/lif_down/evaluation_checks.json',dict(status='PASSED',scope='two duplicated real training images only, no full val/test',
