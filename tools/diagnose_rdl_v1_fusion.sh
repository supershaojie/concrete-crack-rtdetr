...
keys=('runtime','controlled_source_sha256','original_status','original_assertion','finding','diagnostic_status',
      'diagnostic_error','validation_invariants','unfused_snapshot_state_exact','fusion_invariants','reproduce_original','inside_score_head','precision_scope','fusion_acceptance')
