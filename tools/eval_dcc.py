...
from dcc_common import ROOT, VARIANTS, require, sha256, write_json, runtime, verify_model
from train_dcc import code_identity, dataset_identity
...
def evaluate(args):
    ...
    require(not out.exists(), "Existing independent evaluation protected")
